...
def read_annotation_yolov5(size=(640, 480)):
    ...
    aug_bbox_path = aug_path + cls + 'aug_bbox_information.txt'
...
for i, image_paths in enumerate(image_sets):
    ...
    generate_annotation(output_path, image_paths, aug_image_paths)

aug_image_paths = getImagesInDir(augImage_dir)
...
for i, aug_image_paths in enumerate(aug_image_sets):
    ...
    # generate annotation files to labels folder
    aug_generate_annotation(output_path, image_paths, aug_image_paths)
