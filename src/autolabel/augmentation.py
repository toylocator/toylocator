...
def scale_image(image, scale_factor, bb):
    ...
    new_boundingbox = [int(np.round(bb[0] * scale_factor)), int(np.round(bb[1] * scale_factor)), int(np.round(bb[2] * scale_factor)), int(np.round(bb[3] * scale_factor))]    
...
bbox_path = input_path + obj + 'bbox_information.txt'
...
for n in range(len(image_paths)):
    ...
    img, bb = rotate_image(original_image, 30, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
       
    aug_bbox = int(bb[0]), int(bb[1]), int(bb[2]) - int(bb[0]), int(bb[3]) - int(bb[1])
    aug_bbox_path = input_path + obj + 'aug_bbox_information.txt'
    with open(aug_bbox_path, 'a') as file:
        file.write(" ".join([str(a) for a in aug_bbox]) + '\n')

    img, bb = rotate_image(original_image, 60, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = rotate_image(original_image, 90, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = width_shift_image(original_image, 0.2, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = width_shift_image(original_image, 0.4, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = height_shift_image(original_image, 0.2, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = height_shift_image(original_image, 0.4, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = horizontal_flip(original_image, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = scale_image(original_image, 0.5, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
    ...
    img, bb = scale_image(original_image, 1.5, dimension_list[n])
    cv2.rectangle(img, (bb[0], bb[1]), (bb[2], bb[3]) , (255, 0, 0), 2, 1)
    cv2.imwrite(input_path+obj+"/"+obj+"_"+"aug"+str(i)+".jpg", img)
    i += 1
